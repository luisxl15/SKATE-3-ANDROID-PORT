...
An Android (arm64) port of this project. The Xbox 360 game is **statically
recompiled** to native code — this is not an emulator: the PowerPC game code is
translated to C++ and compiled to real aarch64, with Vulkan for graphics and
SDL3 for input, audio and windowing.
...
- The recompilation and the native renderer come from the upstream project — see
  [`README.md`](README.md).
